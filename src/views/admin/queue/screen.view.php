                            ...
                            <div class=" w-full">
                                <div class="flex items-center ps-4 border border-gray-200 rounded dark:border-gray-700">
                                    <span for="bordered-checkbox-1"
                                        ...
                                        <span class="badge bg-primary-600 text-white">4th Year</span></span>
                                </div>
                                ...
                                <div class="flex items-center ps-4 border border-gray-200 rounded dark:border-gray-700">
                                    <span for="bordered-checkbox-1"
                                        ...
                                        <span>Course: </span>
                                        <span class="word-break">Batchelor of Science in Computer
                                            Science</span></span>
                                    </span>
                                </div>
                            </div>
...
<?php require from("views/helper/components/ui/BookingDetailsModal.php") ?>

            ...
            <div
                ...
                <div
                    ...
                    <div
                        ...
                        <a href="/operator/create" type="button"
                            ...
                            <?php foreach ($operator as $items): ?>
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class=" flex justify-center items-center">
                                        ...
                                        <a href="/operator/update?id=<?= $items["ID"] ?>" type="button"
...
<?php display("views/helper/components/ui/DeleteModal.php", ["route" => "/operator/delete"]) ?>

            ...
            <div
                ...
                <div
                    ...
                    <div
                        ...
                        <a href="/department/create" type="button"
                ...
                <div class="overflow-x-auto" style="height: calc(100vh - 240px);">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                <th scope="col" class="px-4 py-3">Operator Name</th>
                                <th scope="col" class="px-4 py-3">Name</th>
                                <th scope="col" class="px-4 py-3">Window</th>
                            ...
                            <?php foreach ($department as $items): ?>
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class=" flex justify-center items-center">
                                        ...
                                        <a href="/batch/update?id=<?= $items["DEPARTMENT_ID"] ?>" type="button"
                                        ...
                                        <button type="button" data-delete-id="<?= $items["DEPARTMENT_ID"] ?>"
...
<?php display("views/helper/components/ui/DeleteModal.php", ["route" => "/department/delete"]) ?>

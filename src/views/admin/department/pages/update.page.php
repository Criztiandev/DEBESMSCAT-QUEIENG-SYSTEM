                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div>
                        ...
                        <select name="STATUS" id="STATUS"
                            ...
                            <option value="full" <?= isset($details["STATUS"]) && $details["STATUS"] == 'full' ? 'selected' : '' ?>>Full</option>
                            <option value="deactive" <?= isset($details["STATUS"]) && $details["STATUS"] == 'deactive' ? 'selected' : '' ?>>Deactive</option>
                        </select>
                    </div>
